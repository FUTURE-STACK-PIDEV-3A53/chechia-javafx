    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            if (translationService == null) {
                throw new IllegalStateException("Impossible d'initialiser le service de traduction");
            }
            
            // Initialiser les filtres
            filterType.getItems().addAll(translationService.translateToEnglish("Académique"), translationService.translateToEnglish("Culturel"), translationService.translateToEnglish("Professionnel"));
            filterNationality.getItems().addAll(translationService.translateToEnglish("Tunisie"), translationService.translateToEnglish("France"), translationService.translateToEnglish("Allemagne"), translationService.translateToEnglish("Italie"), translationService.translateToEnglish("Espagne"));

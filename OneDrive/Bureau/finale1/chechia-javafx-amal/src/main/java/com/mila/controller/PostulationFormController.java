...
import com.mila.service.EmailService;
...
public class PostulationFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Setup field validation and styles
    ...
    /**
     * Configure les checkboxes pour les types d'entretien
     */
                ...
                if (success) {
                    ...
                    try {
                        emailService.sendConfirmationEmail(
                            ...
                            nomField.getText(),
                            prenomField.getText(),
                            programmeComboBox.getValue().getNomProgramme()
                        );
                    } catch (RuntimeException e) {
                        showAlert(Alert.AlertType.WARNING, "Attention", "Erreur d'envoi d'email", 
                                "La postulation a été enregistrée mais l'email de confirmation n'a pas pu être envoyé.");
                    }
                    ...
                    transition.setOnFinished(event -> {
                        ...
                        showAlert(Alert.AlertType.INFORMATION, "Succès", "Postulation enregistrée", 
                                "Votre postulation a été enregistrée avec succès. Un email de confirmation vous a été envoyé.");
     ...
     */
    /**
     * Récupère le type d'entretien sélectionné
     * @return Le type d'entretien sélectionné ou EN_LIGNE par défaut
     */
    ...
    private void handleTranslate() {
        // Cette méthode est désormais vide car la traduction est supprimée
    }
}
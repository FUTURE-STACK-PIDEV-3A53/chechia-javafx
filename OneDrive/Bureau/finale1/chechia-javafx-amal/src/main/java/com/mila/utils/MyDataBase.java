...
public class MyDataBase {
    ...
    private final String URL = "jdbc:mysql://127.0.0.1:3306/chachia?maxAllowedPacket=16777216";
    private final String USERNAME = "root";
    private final String PASSWORD = "";
    private Connection cnx;
    private boolean connectionFailed = false;
    public static boolean isConnectionFailed() {
        return getInstance().connectionFailed;
    }
    ...
    private MyDataBase() {
        try {
            ...
            System.err.println("L'application fonctionnera en mode hors ligne avec des données de démonstration.");
            e.printStackTrace();

...
public class ReservationFXController implements Initializable {
    ...
    @FXML private TextField dateReservationField;
    ...
    private void handleAdd() {
        if (validateInput()) {
            try {
                ...
                String numTel = dateReservationField.getText();
    ...
    private boolean validateInput() {
        ...
        if (dateReservationField.getText().trim().isEmpty()) {
